...
7. PCA analysis would indicate that if we use linear regression, fitting a model with 5 features would be a good decision already (to be confirmed in our bonus section!)
```{r message=FALSE}
