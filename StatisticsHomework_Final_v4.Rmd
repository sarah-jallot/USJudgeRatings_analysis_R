...
From the Cramer-Rao bound theorem, we derive that the variance of $\hat\theta_2$ is necessarily bigger than $\frac{theta}{n}$, which is the Cramer-Rao bound and the variance of $\hat\theta_{ML}$.  
